...
for($i = 0; $i < sizeof($result); $i++){    
        ...
        $rows .= "<td><img src ='./images/movielist/movielist".$i.".jpg' width=50px/></td>";
        $rows .= '</tr>';  
}
...
$rows3 = '';                   
    ...
    $rows3 .= "<a href='".$result2->image."'><img src='./images/recipes/fishdish.jpg' width='400' /></a>";     
          ...
          <div>            
            ...
            <div class="slideshow-container">
              ...
              <div class="mySlides fade">
                ...
                <img src="./images/movie6.jpg" style="width:100%">
              ...
              <div class="mySlides fade">
                ...
                <img src="./images/movie7.jpg" style="width:100%">
                <!-- <div class="hidden">Caption Four</div> -->
              </div>

              <div class="mySlides fade">
                <div class="numbertext">5 / 7</div>
                <img src="./images/couple4.jpg" style="width:100%">
              ...
              <div class="mySlides fade">
                ...
                <img src="./images/couple3.jpg" style="width:100%">
                <!-- <div class="hidden">Caption Five</div> -->
              </div>
           ...
           <!-- End Container 1 -->
            ...
            <div class="container4">
              <div>
                <img src="./images/couple2.jpg"  width="350"/> 
              </div>
              <div>
                <h3>Things to Do</h3>
